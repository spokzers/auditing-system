                                     ...
                                     echo '<div id='.$temp_id.' class="modal modal-fixed-footer" style="width:33%;height:50%">
                                        ...
                                        <div class="modal-content">
                                         ...
                                         <div class="modal-footer">
                                             <a href="#!" id="submit_report" data-audit-id="'.$temp_id.'" class="waves-effect white-text blue btn-flat modal-action">Submit</a>
                                             <a href="'.$temp_url.'" style="margin-left:5px;" class="waves-effect white-text amber btn-flat modal-action modal-close">Close</a>
                                         </div>
                                       </div>';
